        ...
        <div class="col-12 col-md-6">
            <div class="card" style="height: 500px;border: none;">
                <div class="card-body d-flex flex-column align-items-center justify-content-center">
                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Hello, new user? 👋. </p>
                    ...
                    <form method="POST" action="/register" class="mx-1 mx-md-4">
                        ...
                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                            ...
                            <button type="submit" data-mdb-button-init data-mdb-ripple-init
                                class="btn btn-dark btn-lg" style="background-color: #ffa200; border: none" >Register</button>
                        </div>
